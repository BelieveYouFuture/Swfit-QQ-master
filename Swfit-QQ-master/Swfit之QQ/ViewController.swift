...
class ViewController: UITabBarController
{
    ...
    override func viewDidLoad() {
        ...
        self.getAddChrldControl(ZWYNews(), titlname: "消息", imageNme: "tab_recent_nor")
        
        self.getAddChrldControl(ZWYContacter(), titlname: "联系人", imageNme: "tab_buddy_nor")
        
        self.getAddChrldControl(ZWYDynamicController(), titlname: "动态", imageNme: "tab_qworld_nor")
